<template>
  ...
  <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          <span class="text-xs uppercase tracking-wide text-gray-500"> Footer </span>
        ...
        <ul class="mt-8 flex gap-6">
          <li>
            <a
              href="https://www.facebook.com/carlos.hernandez.15"
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.instagram.com/rober.salama/"
              rel="noreferrer"
              target="_blank"
              class="text-gray-700 transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://twitter.com/rober_salama"
              rel="noreferrer"
              target="_blank"
              class="text-gray-700 transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://github.com/ROBER-SALAMA"
              rel="noreferrer"
              target="_blank"
              class="text-gray-700 transition hover:opacity-75"
            >
    ...
    <div class="mt-3 border-t border-gray-100 pt-12">
